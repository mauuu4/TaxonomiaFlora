<div class="mb-8">
    <form method="GET" action="{{ route('especies.index') }}" class="bg-white rounded-xl shadow-lg p-6">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            ...
            <a href="{{ route('especies.index') }}" class="inline-flex items-center px-6 py-2.5 bg-blue-500 hover:bg-blue-600 text-white font-medium text-sm rounded-lg transition duration-200 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 whitespace-nowrap">
