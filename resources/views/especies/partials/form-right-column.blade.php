        ...
        <div>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="ubi_region" type="text" name="ubi_region" 
                    :value="old('ubi_region')" required class="mt-1 block w-full bg-gray-50" placeholder="Ej: Región Andina"/>
            ...
            <div class="mt-4">
                ...
                <textarea id="ubi_descripcion" name="ubi_descripcion" 
                    ...
                    rows="2" placeholder="Ej: Zona montañosa cercana al río, altitud 2800 msnm...">
                    {{ old('ubi_descripcion') }}
                </textarea>
