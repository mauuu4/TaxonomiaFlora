<tr class="hover:bg-gray-50">
    ...
    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
        @php
            $ruta = $viewType === 'taxonomo' 
                ? route('validate.show', $registro->regis_id) 
                : route('especies.show', $registro->esp_id);
        @endphp
    
        <a href="{{ $ruta }}" class="text-indigo-600 hover:text-indigo-900 inline-flex items-center gap-1">
            {{ $viewType === 'taxonomo' ? 'Revisar' : 'Ver detalles' }}
